        ...
        body: StreamBuilder(
            ...
            builder: (context, AsyncSnapshot<List<User>> snapshot) {
              ...
              return StreamBuilder(
                  stream:
                      _t_dao.watchAllTrainings(),
                  builder:
                      (context, AsyncSnapshot<List<Training>> snapshot) {

                        itemsCount = user != null ? double.parse(user.trainingTimesPerWeek).toInt() : 1 ;
...
//                              .weekday - 1));
                      ...
                      var thisMonday = DateTime(DateTime.now().year, DateTime.now().month, DateTime.now().day, 9, 0, 0, 0, 0);
                      ...
                      var thisFriday = thisMonday.add(
                          new Duration(days: 4));
                      var thisSaturday = thisMonday.add(
                          new Duration(days: 5));
                      var thisSunday = thisMonday.add(
                          new Duration(days: 6));
                      ...
                      if (user != null && trainingsList.isEmpty && traings != null) {
                        itemsCount = double.parse(user.trainingTimesPerWeek).toInt();
                        ...
                        for (int i = 0; i < itemsCount; i++) {
                          ...
                          do {
                            ...
                            if (i == 5) {trainingDate = thisSaturday;}
                            if (i == 6) {trainingDate = thisSunday;}


                            var baseTraining = sortedExercises[
                            Random().nextInt(sortedExercises.length)];
                                                      ...
                                                      borderRadius:
                                                          BorderRadius.all(
                                                              Radius
                                                                  .circular(
                                                                      4.0)),
                                                      color: Color.fromRGBO(231, 231, 231, 0.65),
                                                    ),
                                                  )
                                                : Container(),
                                              ...
                                              child: Padding(
                                                padding:
                                                    const EdgeInsets.only(
                                                        right: 12.0,
                                                        bottom: 12.0),
                                                child: trainingsList[index].isDone
                                                    ? Align(
                                                        alignment: Alignment
                                                            .bottomRight,
                                                        child: Stack(
                                                ...
                                                child: Text(
                                                  ...
                                                  style: TextStyleBuilder
                                                      .textStyleBuilder(
                                                          24,
                                                          600,
                                                      trainingsList[index].isDone ? TextStyleColors
                                                          .black : TextStyleColors
                                                              .white ,
                                                          FontStyle.normal, context),
                                                ),
                                                alignment:
