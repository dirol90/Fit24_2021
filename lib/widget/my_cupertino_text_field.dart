...
class _MyCupertinoTextFieldSelectionGestureDetectorBuilder extends TextSelectionGestureDetectorBuilder {
  _MyCupertinoTextFieldSelectionGestureDetectorBuilder({
    @required _MyCupertinoTextFieldState state,
  }) : _state = state,
        super(delegate: state);

  final _MyCupertinoTextFieldState _state;
...
///     return MyCupertinoTextField(controller: _textController);
///   }
/// }
/// ```
/// {@end-tool}
...
class MyCupertinoTextField extends StatefulWidget {
  ...
  /// ## Limitations
  ///
  /// The MyCupertinoTextField does not currently count Unicode grapheme clusters
  ...
  @override
  _MyCupertinoTextFieldState createState() => _MyCupertinoTextFieldState();
...
class _MyCupertinoTextFieldState extends State<MyCupertinoTextField> with AutomaticKeepAliveClientMixin implements TextSelectionGestureDetectorBuilderDelegate {
  ...
  _MyCupertinoTextFieldSelectionGestureDetectorBuilder _selectionGestureDetectorBuilder;
  ...
  void initState() {
    super.initState();
    _selectionGestureDetectorBuilder = _MyCupertinoTextFieldSelectionGestureDetectorBuilder(state: this);
  ...
  @override
  void didUpdateWidget(MyCupertinoTextField oldWidget) {
  ...
  // MyCupertinoTextField has top alignment by default, unless it has decoration
